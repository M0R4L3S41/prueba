...
def overlay_pdf_on_background(pdf_file, output_stream, apply_front, apply_rear, apply_folio):
    try:
        ...
        if apply_folio:
            ...
            first_page.insert_text((45, 45), "FOLIO", fontsize=14,fontname="helv-Bold", color=(0, 0, 0))
            # Insertar debajo el código de barras en (45, 109)
            barcode_text = "A30 " + str(folio_random)
            first_page.insert_text((45, 60), barcode_text, fontsize=12, fontname="helv-Bold", color=(0, 0, 0))
